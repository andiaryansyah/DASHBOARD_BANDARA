              ...
              <form className="space-y-4 md:space-y-6" onSubmit={handleClick}>
                  ...
                  <div className="flex items-start">
                      ...
                      <div className="ml-3 text-sm">
                        <label for="terms" className="font-light text-gray-500 ">I accept the <Link className="font-medium text-primary-600 hover:underline " to="/register">Terms and Conditions</Link></label>
                      </div>
                  </div>
                  ...
                  <p className="text-sm font-light text-gray-500 ">
                      Sudah punya akun ? <Link to="/" className="font-medium text-primary-600 hover:underline ">Masuk disini</Link>
                  </p>
              </form>
          </div>
      </div>
