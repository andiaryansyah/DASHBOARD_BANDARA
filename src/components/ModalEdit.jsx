...
const ModalEdit = ({addIcon, addTooltip, addClassName, thisClick, getEmail}) => {
            ...
            >
              ...
              <div className="border-0 shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="fixed bg-gray-50 w-1/2 flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t z-40">
                  <h3 className="text-3xl font-semibold"> {thisClick === "preview" ? "Preview" :  "Form Edit"}</h3>
                  <button
                ...
                <div className="relative mt-16">
                  ...
                  >
                    <div>
                       {file ? "ada" : <img src={defaultPhoto} alt="default" className="m-auto object-cover h-28 w-28 rounded-full mb-4" />}
                    </div>
