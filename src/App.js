  ...
  useEffect(() => {
    if (location) {
      ...
      if (temp[1] === "") {
        ...
        const route = capitalizeFirstLowercaseRest(
    ...
    <React.Fragment>
      ...
      <a href="https://www.sultanbantilanairport.com/admin">
        <div className="fixed right-4 bottom-4 z-10 flex items-center group">
          <span className="tooltip-text hidden group-hover:block bg-gray-300 p-2 rounded-md text-sm font-medium">
            sultanbantilanairport.com/admin
          </span>
